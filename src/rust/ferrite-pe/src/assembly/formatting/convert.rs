...
pub(in crate::assembly) fn encode_type_flags(
...
pub(in crate::assembly) fn encode_method_flags(
...
pub(in crate::assembly) fn encode_method_impl_flags(
    method: &dotnetdll::resolved::members::Method,
) -> u16 {
    let mut f: u16 = 0;
...
pub(in crate::assembly) fn encode_field_flags(field: &dotnetdll::resolved::members::Field) -> u16 {
    use dotnetdll::resolved::members::Accessibility as MemAcc;
    use dotnetdll::resolved::Accessibility as Acc;
    let mut f: u16 = 0;
...
pub(in crate::assembly) use super::format_types::format_type_source;

/// Extract call-site info (parameter count, has return value, is static) from a method definition.
pub(in crate::assembly) fn method_call_info(
    method: &dotnetdll::resolved::members::Method,
) -> MethodDefCallInfo {
    MethodDefCallInfo {
...
pub(in crate::assembly) fn encode_method_sig_blob(
...
pub(in crate::assembly) fn convert_field(
    ...
    let constant_value = field
        .default
        .as_ref()
        .map(super::super::parsing::attributes::format_constant);
...
pub(in crate::assembly) fn convert_method(
    method: &dotnetdll::resolved::members::Method,
    token: u32,
    res: &Resolution,
    asm: &mut Assembly,
...
pub(in crate::assembly) fn convert_property(
...
pub(in crate::assembly) fn find_accessor_token(
