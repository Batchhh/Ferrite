...
use super::format::format_type_full_name;
use super::format_types::format_method_ref_parent;
...
pub(super) fn convert_attributes(
...
pub(super) fn convert_field_attributes(
    attrs: &[dotnetdll::resolved::attribute::Attribute],
    res: &Resolution,
) -> Vec<CustomAttribute> {
...
pub(super) fn convert_method_attributes(
    attrs: &[dotnetdll::resolved::attribute::Attribute],
    res: &Resolution,
) -> Vec<CustomAttribute> {
    convert_attributes(attrs, res)
...
pub(super) fn convert_property_attributes(
    attrs: &[dotnetdll::resolved::attribute::Attribute],
    res: &Resolution,
) -> Vec<CustomAttribute> {
    convert_attributes(attrs, res)
...
pub(super) fn get_attribute_type_name(
...
pub(super) fn format_fixed_arg(arg: &dotnetdll::resolved::attribute::FixedArg) -> String {
...
pub(super) fn format_named_arg(arg: &dotnetdll::resolved::attribute::NamedArg) -> String {
...
pub(super) fn format_integral_param(i: &dotnetdll::resolved::attribute::IntegralParam) -> String {
...
pub(super) fn format_constant(c: &Constant) -> String {
    match c {
