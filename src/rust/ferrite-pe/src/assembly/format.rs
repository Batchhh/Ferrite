...
pub(super) fn simplify_method_name(name: &str) -> String {
...
pub(super) fn strip_namespaces_from_type(s: &str) -> String {
...
pub(super) fn split_generic_args(s: &str) -> Vec<&str> {
...
pub(super) fn format_type_full_name(typedef: &TypeDefinition) -> String {
...
pub(super) fn determine_type_kind(typedef: &TypeDefinition, res: &Resolution) -> TypeKind {
    if matches!(
        typedef.flags.kind,
