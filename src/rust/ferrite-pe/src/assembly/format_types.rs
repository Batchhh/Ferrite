...
pub(super) fn format_type_source(ts: &TypeSource<MemberType>, res: &Resolution) -> String {
    match ts {
...
pub(super) fn format_user_type(ut: &UserType, res: &Resolution) -> String {
    match ut {
...
pub(super) fn format_member_type(mt: &MemberType, res: &Resolution) -> String {
    match mt {
...
pub(super) fn format_method_type(mt: &MethodType, res: &Resolution) -> String {
    match mt {
...
pub(super) trait FormatType: Sized {
...
pub(super) fn format_base_type<T: FormatType + Clone>(
    bt: &BaseType<T>,
    res: &Resolution,
) -> String {
    match bt {
...
pub(super) fn format_base_type_method(bt: &BaseType<MethodType>, res: &Resolution) -> String {
    format_base_type(bt, res)
}

pub(super) fn format_type_source_generic<T: FormatType + Clone>(
    ts: &TypeSource<T>,
    res: &Resolution,
) -> String {
    match ts {
...
pub(super) fn format_parameter_type(
...
pub(super) fn format_method_ref_parent(parent: &MethodReferenceParent, res: &Resolution) -> String {
    match parent {
