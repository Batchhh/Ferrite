...
pub(in crate::decompiler) use super::methods::{emit_constructor, emit_method};
use crate::assembly::{Assembly, FieldDef, PropertyDef, TypeDef};
use crate::decompiler::patterns;
use crate::decompiler::INDENT;

pub(in crate::decompiler) fn emit_field(
    field: &FieldDef,
    hoisted_init: Option<&str>,
    out: &mut String,
) {
    out.push_str(INDENT);
...
pub(in crate::decompiler) fn field_visibility(flags: u16) -> &'static str {
    match flags & 0x0007 {
        0x0001 => "private",
...
pub(in crate::decompiler) fn emit_property(
    prop: &PropertyDef,
    td: &TypeDef,
    assembly: &Assembly,
