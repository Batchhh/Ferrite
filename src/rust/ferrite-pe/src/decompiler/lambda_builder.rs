...
pub(super) fn build_lambda_map(td: &TypeDef, assembly: &Assembly) -> LambdaMap {
...
// ---------------------------------------------------------------------------
// Method statement builder (shared by field initializer extraction and ctors)
// ---------------------------------------------------------------------------

/// Build the AST statements for a method body (without emitting to string).
pub(super) fn build_method_statements(
    method: &MethodDef,
    assembly: &Assembly,
    enclosing_type: &str,
...
// ---------------------------------------------------------------------------
// Compiler-generated type detection
// ---------------------------------------------------------------------------
...
/// `<>c__DisplayClass0_0`.
pub(super) fn is_compiler_generated_type(name: &str) -> bool {
...
pub(super) fn extract_leading_field_inits(stmts: &[Statement]) -> Vec<(String, String)> {
...
pub(super) fn extract_field_initializers(
    td: &TypeDef,
    assembly: &Assembly,
...
pub(super) fn is_backing_field(name: &str) -> bool {
