use super::super::LambdaMap;
use crate::decompiler::ast::*;

pub fn inline_lambdas(stmts: Vec<Statement>, lambda_map: &LambdaMap) -> Vec<Statement> {
...
pub fn is_delegate_type(ty: &str) -> bool {
...
pub fn extract_method_name_from_ref(raw: &str) -> Option<&str> {
...
pub fn inline_lambda_expr(expr: Expr, lm: &LambdaMap) -> Expr {
    match expr {
