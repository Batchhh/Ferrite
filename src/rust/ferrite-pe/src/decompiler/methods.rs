...
pub(super) fn emit_params(params: &[crate::assembly::ParamInfo], out: &mut String) {
    if params.is_empty() {
        out.push_str("()");
        return;
    }
...
pub(super) fn method_visibility(flags: u16) -> &'static str {
    match flags & 0x0007 {
        0x0001 => "private",
